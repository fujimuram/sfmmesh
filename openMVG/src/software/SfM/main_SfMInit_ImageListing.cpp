...
int main(int argc, char **argv)
{
    ...
    ++iter_image, ++my_progress_bar )
  {
    ...
    if (focal == -1)
    {
	  ...
	  const bool bHaveValidExifMetadata = true; //exifReader->doesHaveExifInfo() && !exifReader->getModel().empty();

      if (bHaveValidExifMetadata) // If image contains meta data
      {
		  const std::string sCamModel = "example";  ///////////////////////////////////////////////////////////////////////////////////////////////////////// exifReader->getModel() == example;
        ...
        // Create the image entry in the list file
        {
          ...
          if ( getInfo( sCamModel, vec_database, datasheet ))
          {
            ...
            focal = std::max ( width, height ) * 7.3 / ccdw;	/////////////////////////////////////////////////////////////////////////////////////////////////  exifReader->getFocal() == 7.3		
          }
          else
          {
            error_report_stream
