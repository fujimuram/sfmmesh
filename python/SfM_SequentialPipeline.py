...
OPENMVG_SFM_BIN = "D:/ueda/OpenMVG/build/Windows-AMD64-/Release"
OPENMVG_MVS_BIN = "D:/ueda/OpenMVG/build/Windows-AMD64-/Release"
OPENMVG_MVS2_BIN = "D:/ueda/OpenMVS/build/bin/x64/Release"
# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "D:/ueda/OpenMVG"
...
#image_folder
input_dir = os.path.join('D:/ueda/ProjectTest', Test_NAME, 'images')
#Excecute filter
...
#output_folder
output_dir = os.path.join('D:/ueda/ProjectTest', Test_NAME)
matches_dir = os.path.join(output_dir, "matches")
reconstruction_dir = os.path.join(output_dir, "outReconstruction")
working_dir = os.path.join(reconstruction_dir, "depthmap")
...
pFeatures = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ComputeFeatures"),  "-i", matches_dir+"/sfm_data.json", "-o", matches_dir, "-m", "AKAZE_FLOAT", "-n", "6"], stdout = subprocess.PIPE, stderr = subprocess.STDOUT)
...
print ("10. Generating OpenMVS file")
pConvert = subprocess.Popen( [os.path.join(OPENMVG_MVS_BIN, "openMVG_main_openMVG2openMVS"),  "-i", reconstruction_dir+"/sfm_data.bin", "-o", os.path.join(reconstruction_dir,"scene.mvs"), "-d", reconstruction_dir+"/undistorted_images"], stdout = subprocess.PIPE, stderr = subprocess.STDOUT)
...
pDensify = subprocess.Popen( [os.path.join(OPENMVG_MVS2_BIN, "DensifyPointCloud"), "--resolution-level", "0", "--NCCThreshold", "0.55", os.path.join(reconstruction_dir,"scene.mvs"), "-w", working_dir], stdout = subprocess.PIPE, stderr = subprocess.STDOUT)
